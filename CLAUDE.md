...
.github/workflows/
  collect.yml                    ← 거울 전날 결산 수집 (cron-job.org → 매일 00:05 KST + 30분 재시도)
...
| `collect.yml` | 매일 00:05 + 30분 재시도 | 00:05 | 거울 전날 결산 (성공 시 스킵) |
| `inactive.yml` | 매일 | 07:00 | 거울/달라 장기 미접속 Discord 알림 |
| `weekly-report.yml` | 매주 목 | 09:00 | 거울/달라 주간 리포트 Discord |
